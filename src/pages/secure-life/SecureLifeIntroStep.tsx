...
export const SecureLifeIntroStep = ({
  ...
  return (
    <div className="secure-life-step chat-block mb-4 rounded-[28px] p-1">
      <div className="name-tag mb-2 ml-12 text-[11px] font-bold tracking-[0.28em] text-[#0f4f91] uppercase sm:text-[11px]">
        Sophia · Secure Life
      </div>
      ...
      <div className="options-row mt-3 flex flex-wrap gap-2.5 pl-12 sm:pl-12">
        <button
          type="button"
